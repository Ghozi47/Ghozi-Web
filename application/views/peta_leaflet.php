...
<script>
    ...
    var groupedOverlays = {
        "Peta Dasar": {
            ...
            'Provinsi': provin,
            'Fasilitas Sekitar Jombang': sekitar
        },
        "Peta Khusus": {
    ...
    $.getJSON("<?= base_url() ?>assets/mapping.geojson", function(data) {
        var ratIcon = L.icon({
            iconUrl: '<?= base_url() ?>assets/Marker-5.png',
            iconSize: [12, 10]
        });
        L.geoJson(data, {
            pointToLayer: function(feature, latlng) {
                ...
                marker.bindPopup(feature.properties.Location_Name);
                return marker;
            }
        }).addTo(sekitar);
    });
